...
import { createChapter, getChapterStatus, getProject, listChapters, type ChapterRead } from "./api";
...
export function ProjectDashboardPage() {
  ...
  const createChapterMutation = useMutation({
    ...
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: ["project-chapters", projectId] });
      setChapterTitle("");
